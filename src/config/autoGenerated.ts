...
const autoGeneratedMessage = [
  autoGeneratedString,
  '',
  'To modify this file, please consider creating a .cdk-ez.config.ts file to',
  'use hooks to override cdk-ez opinions so that we can maximize forward',
  'compatibility. Otherwise, remove this comment and especially any reference',
  'to this string:',
  '',
  autoGeneratedString,
];

export function createExportsJsFile(exportString: string): string {
  return `
/**
